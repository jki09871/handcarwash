    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <div class="ml-auto">
                    <a class="btn btn-custom" href="/api/v1/auth/login.do">Sing In/Up</a>
                </div>
                    </c:when>
                    <c:otherwise>
                <div class="ml-auto">
                        <a class="btn btn-custom" style="margin:5px">${sessionScope.login.name}</a></button>
                        <a class="btn btn-custom" href="/api/v1/auth/logout.do">Logout</a>
                </div>
                    </c:otherwise>
                </c:choose>
            </div>
